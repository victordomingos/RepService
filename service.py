...
class App(baseApp):
    ...
    def gerar_painel_entrada(self):
        ...
        self.ef_text_descr_equipamento.grid(column=0, row=1, columnspan=2, rowspan=4, padx=5, sticky='wens')
        ...
        self.ef_text_obs_estado_equipamento.grid(column=3, row=1, rowspan=4, padx=5, sticky='wens')
        ...
        self.ef_lbl_cod_artigo.grid(column=0, row=5, padx=5, sticky='we')
        self.ef_txt_cod_artigo.grid(column=0, row=6, padx=5, sticky='we')
        self.ef_lbl_num_serie.grid(column=1, row=5, padx=5, sticky='we')
        self.ef_txt_num_serie.grid(column=1, row=6, padx=5, sticky='we')
        self.ef_lbl_data_compra.grid(column=2, row=5, padx=5, sticky='we')
        self.ef_txt_data_compra.grid(column=2, row=6, padx=5, sticky='we')
        self.ef_lbl_num_fatura.grid(column=3, row=5, padx=5, sticky='we')
        self.ef_txt_num_fatura.grid(column=3, row=6, padx=5, sticky='we')
        ...
        self.ef_text_descr_avaria_servico = ScrolledText(self.ef_lf_servico, highlightcolor="LightSteelBlue2", width=20, height=5)
        ...
        self.ef_text_acessorios_entregues = ScrolledText(self.ef_lf_outros_dados, highlightcolor="LightSteelBlue2", height=2)
        ...
        self.ef_text_notas = ScrolledText(self.ef_lf_outros_dados, highlightcolor="LightSteelBlue2", height=2)
        ...
        self.ef_lbl_notas.grid(column=1, row=0, padx=5, sticky='we')
    ...
    def radio_tipo_command(self, *event):
        ...
        if tipo == TIPO_REP_STOCK:
            ...
            self.ef_lbl_obs_estado.grid_remove()
            self.ef_text_obs_estado_equipamento.grid_remove()
            ...
            self.ef_lbl_data_compra.grid_remove()
            self.ef_txt_data_compra.grid_remove()
            self.ef_lbl_num_fatura.grid_remove()
            ...
            self.ef_txt_cod_artigo.grid(column=2, row=1, padx=5, sticky='w')
            self.ef_lbl_num_serie.grid(column=2, row=2, padx=5, sticky='w')
            self.ef_txt_num_serie.grid(column=2, row=3, padx=5, sticky='w')
            self.ef_lbl_num_fatura_fornecedor.grid(column=3, row=0, padx=5, sticky='w')
            self.ef_txt_num_fatura_fornecedor.grid(column=3, row=1, padx=5, sticky='w')
            self.ef_lbl_data_fatura_fornecedor.grid(column=3, row=2, padx=5, sticky='w')
            self.ef_txt_data_fatura_fornecedor.grid(column=3, row=3, padx=5, sticky='w')
            self.ef_lbl_nar.grid(column=3, row=4, padx=5, sticky='w')
            self.ef_txt_nar.grid(column=3, row=5, padx=5, sticky='w')
            self.ef_lbl_num_guia_rececao.grid(column=4, row=0, padx=0, sticky='w')
            self.ef_txt_num_guia_rececao.grid(column=4, row=1, padx=1, sticky='w')
            self.ef_lbl_data_entrada_stock.grid(column=4, row=2, padx=2, sticky='w')
            self.ef_txt_data_entrada_stock.grid(column=4, row=3, padx=3, sticky='w')
            self.ef_lbl_num_quebra_stock.grid(column=4, row=4, padx=5, sticky='w')
            self.ef_txt_num_quebra_stock.grid(column=4, row=5, padx=5, sticky='w')
            ...
            self.ef_lbl_obs_estado.grid()
            self.ef_text_obs_estado_equipamento.grid()
            ...
            self.ef_lbl_nar.grid_remove()
            self.ef_txt_nar.grid_remove()
            self.ef_lbl_num_fatura_fornecedor.grid_remove()
            self.ef_txt_num_fatura_fornecedor.grid_remove()
            self.ef_lbl_data_fatura_fornecedor.grid_remove()
            self.ef_txt_data_fatura_fornecedor.grid_remove()
            self.ef_lbl_num_guia_rececao.grid_remove()
            self.ef_txt_num_guia_rececao.grid_remove()
            self.ef_lbl_data_entrada_stock.grid_remove()
            self.ef_txt_data_entrada_stock.grid_remove()
            self.ef_lbl_num_quebra_stock.grid_remove()
            self.ef_txt_num_quebra_stock.grid_remove()
            self.ef_lbl_num_serie.configure(text="\nNº de série")
            self.ef_lbl_cod_artigo.configure(text="\nCódigo de artigo")
            self.ef_lbl_cod_artigo.grid(column=0, row=5, padx=5, sticky='we')
            self.ef_txt_cod_artigo.grid(column=0, row=6, padx=5, sticky='we')
            self.ef_lbl_num_serie.grid(column=1, row=5, padx=5, sticky='we')
            self.ef_txt_num_serie.grid(column=1, row=6, padx=5, sticky='we')
            ...
            self.ef_lf_outros_dados.configure(text="\nOutros dados")
            self.ef_lbl_acessorios_entregues.grid()
            self.ef_text_acessorios_entregues.grid()
            self.ef_lbl_local_intervencao.grid()
            self.ef_combo_local_intervencao.grid()

            self.ef_lbl_notas.grid(column=1, row=0, padx=5, sticky='we')
            self.ef_text_notas.grid(column=1, row=1, columnspan=1, rowspan=3, padx=5, sticky='wens')
            self.ef_txt_num_cliente.focus()
    ...
    def radio_garantia_command(self, *event):
        ...
        if garantia == GARANTIA_NOUTRO:
            self.ef_lbl_local_compra.grid(column=4, row=5, padx=5, sticky='we')
            self.ef_txt_local_compra.grid(column=4, row=6, padx=5, sticky='we')
        else:
            self.ef_lbl_local_compra.grid_remove()
            self.ef_txt_local_compra.grid_remove()
